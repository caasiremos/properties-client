...
const amenitiesList = ['Swimming Pool', 'Garden', 'Parking', 'Security', 'Gym'];
const conditions = ['Brand New', 'Excellent', 'Good', 'Needs Renovation'];
  ...
  <form @submit.prevent="submitForm" class="space-y-6">
    ...
    <div>
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
        <label v-for="amenity in amenitiesList" 
               :key="amenity"
    ...
    <div class="flex justify-end">
      <button type="submit"
              class="bg-primary-600 text-white px-6 py-2 rounded-md hover:bg-primary-700 focus:outline-hidden focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
        Get Free Valuation
      </button>
    </div>
  </form>
