  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-white shadow-sm">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <h1 class="text-3xl font-bold text-gray-900">Furnished Properties for Rent</h1>
        <p class="mt-2 text-gray-600">Discover fully furnished rental properties in Uganda</p>
      </div>
    </div>
